      ...
      <div className="max-w-4xl mx-auto my-8 px-4">
        ...
        <div className="space-y-10">
          ...
          <div className="p-6 bg-white rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold text-gray-700 mb-4 text-center">1. What is your skin type?</h2>
          ...
          <div className="p-6 bg-white rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold text-gray-700 mb-4 text-center">2. What is your main skin concern?</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="p-6 bg-white rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold text-gray-700 mb-4 text-center">3. What's your experience level?</h2>
